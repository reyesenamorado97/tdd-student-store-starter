import bigLogo from "../../assets/giant_codepath.svg"
import "./About.css"
        ...
        <div id="About" className="about">
            <div className="content">
                ...
                <div className="summary">
                    ...
                    <div className="text">
                        <p>
                            The codepath student store offers great products 
                            at great prices from a great team and for a great cause.
                        </p>
                    ...
                    <div className="media">
                        <img src={bigLogo} alt="Big Codepath Logo" />
                    </div>
                </div>
            </div>
        </div>
